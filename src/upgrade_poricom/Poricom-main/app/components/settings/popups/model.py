...
class ModelOptions(BaseOptions):
    def __init__(self, parent: QWidget):
        ...
        # self.languageComboBox.addItems(["Japanese", "Korean", "Chinese SIM", "Chinese TRA", "English"])

        # self.orientationLabel = QLabel("Orientation:", self)
        # self.orientationComboBox = QComboBox(self)
        # self.orientationComboBox.addItems(["Vertical", "Horizontal"])
